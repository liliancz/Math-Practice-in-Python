...
################### HELPFULL FUNCTIONS ##############
    ...
    def load(self):
        self.background = pygame.image.load('layout.png')
        self.background = pygame.transform.scale(self.background,(MAZE_WIDTH, MAZE_HEIGHT)) 
        self.inst = pygame.image.load('ins.png')
        self.inst = pygame.transform.scale(self.inst,(MAZE_WIDTH, MAZE_HEIGHT)) 
...
################### INSTRUCTIONS FUNCTIONS ######################################################
    ...
    def Inst_draw(self):
        self.screen.fill(BLACK)
        self.screen.blit(self.inst, (TOP_BOTTOM_BUFFER//2,TOP_BOTTOM_BUFFER//2))
        pygame.display.update()
